module.exports = {
    ...
    elements: {
        fillPasswordLogin: by.xpath("//input[@id='password']")
    },

    perform: function () {

        var selector = page.fillPasswordLogin.elements.fillPasswordLogin;
        return driver.findElement(selector).sendKeys('Kmzway19');
    }
};
